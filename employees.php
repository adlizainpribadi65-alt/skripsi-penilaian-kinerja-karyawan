...
<div class="app-container">
    ...
    <main class="content-main">
        <?php if (isset($_SESSION['success_msg'])): ?>
            <div class="alert alert-success alert-dismissible fade show glass ms-0 mb-4" role="alert" style="background: rgba(16, 185, 129, 0.1); border: 1px solid rgba(16, 185, 129, 0.2); color: #10b981;">
        ...
        <?php if (isset($_SESSION['error_msg'])): ?>
            <div class="alert alert-danger alert-dismissible fade show glass ms-0 mb-4" role="alert" style="background: rgba(239, 68, 68, 0.1); border: 1px solid rgba(239, 68, 68, 0.2); color: #ef4444;">
                                            ...
                                            <td class="text-end pe-5">
                                                <div class="d-flex justify-content-end gap-2">
                                                    <a href="industrial/enroll_face.php?id=<?= $emp['id'] ?>"
                                                        ...
                                                        style="background: rgba(34, 211, 238, 0.05); box-shadow: none; border: 1px solid rgba(34, 211, 238, 0.2); color: var(--cyan);" title="Daftar Wajah">
        ...
        <div class="modal-content glass shadow-2xl border-0" style="background: var(--bg-card); backdrop-filter: blur(25px);">
            ...
            <form action="employees.php" method="POST">
                ...
                <div class="modal-body p-4">
                    <div class="mb-4">
                        <label class="form-label text-muted small fw-bold text-uppercase tracking-widest">Hash ID / NIK</label>
                        <input type="text" name="nik" class="form-control-glass w-100" placeholder="Contoh: 2024001" required>
                    </div>
                    <div class="mb-4">
                        <label class="form-label text-muted small fw-bold text-uppercase tracking-widest">Nama Lengkap</label>
                        <input type="text" name="name" class="form-control-glass w-100" placeholder="Masukkan nama lengkap..." required>
                    </div>
                    <div class="mb-4">
                        <label class="form-label text-muted small fw-bold text-uppercase tracking-widest">Posisi / Jabatan</label>
                        <input type="text" name="position" class="form-control-glass w-100" placeholder="Contoh: Senior Tailor" required>
                    </div>
                    <div class="mb-0">
                        <label class="form-label text-muted small fw-bold text-uppercase tracking-widest">Divisi / Departemen</label>
                        <input type="text" name="department" class="form-control-glass w-100" placeholder="Contoh: Produksi Utama" required>
                    </div>
                </div>
        ...
        <div class="modal-content glass shadow-2xl border-0" style="background: var(--bg-card); backdrop-filter: blur(25px);">
            ...
            <form action="employees.php" method="POST">
                ...
                <div class="modal-body p-4">
                    <div class="mb-4">
                        <label class="form-label text-muted small fw-bold text-uppercase tracking-widest">Hash ID / NIK</label>
                        <input type="text" name="nik" id="edit-nik" class="form-control-glass w-100" placeholder="Contoh: 2024001" required>
                    </div>
                    <div class="mb-4">
                        <label class="form-label text-muted small fw-bold text-uppercase tracking-widest">Nama Lengkap</label>
                        <input type="text" name="name" id="edit-name" class="form-control-glass w-100" placeholder="Masukkan nama lengkap..." required>
                    </div>
                    <div class="mb-4">
                        <label class="form-label text-muted small fw-bold text-uppercase tracking-widest">Posisi / Jabatan</label>
                        <input type="text" name="position" id="edit-position" class="form-control-glass w-100" placeholder="Contoh: Senior Tailor" required>
                    </div>
                    <div class="mb-0">
                        <label class="form-label text-muted small fw-bold text-uppercase tracking-widest">Divisi / Departemen</label>
                        <input type="text" name="department" id="edit-department" class="form-control-glass w-100" placeholder="Contoh: Produksi Utama" required>
                    </div>
                </div>
                <div class="modal-footer border-top border-white border-opacity-10 p-4 pt-0">
                    <button type="button" class="btn text-white-50 fw-bold me-3" data-bs-dismiss="modal">BATAL</button>

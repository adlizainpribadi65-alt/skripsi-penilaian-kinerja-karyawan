...
<div class="app-container">
    ...
    <main class="content-main">
        <header class="header-section mb-5 animate-fadeIn">
            <div>
                <h1 class="display-4 fw-bold text-white mb-2 brand-font">REEGIOELLA <span
                        class="shimmer-text">HUB</span></h1>
                <p class="text-muted fs-5">Sistem Pendukung Keputusan Penilaian Kinerja Karyawan AHP & SAW</p>
            </div>
        </header>
                    ...
                    <div class="row g-4 mt-2">
                        ...
                        <div class="col-md-6">
                            <div class="glass-pane p-4">
                                ...
                                <div class="text-muted small fw-bold uppercase tracking-widest mt-2">Parameter Kriteria
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                                ...
                                <div class="d-flex align-items-end gap-3" style="height: 200px;">
                                    <?php foreach ($top_performers as $p): ?>
                                        <div class="flex-grow-1 d-flex flex-column align-items-center">
                                            <div class="w-100 shadow-glow"
                                                style="height: <?= ($p['avg_score'] / 100 * 100) ?>%; background: linear-gradient(180deg, var(--primary) 0%, transparent 100%); border-radius: 8px 8px 0 0;">
                                            </div>
                                            <div class="tiny text-white-50 mt-2 text-truncate w-100 text-center">
            ...
            <div class="col-span-4 animate-fadeIn stagger-1">
                <div class="glass bento-card shadow-lg h-100">
                    ...
                    <div class="text-center py-4">
                        <div class="metric-value" style="font-size: 4rem; color: var(--secondary);">
                            <?= $presence_rate ?>%</div>
